...
Read `.feature-radar/base.md` for project context and classification rules. If it doesn't exist, run the `feature-radar` skill first to bootstrap.
...
4. **Run extraction checklist** (mandatory — do NOT skip):
...
For each check, explicitly state the finding:
